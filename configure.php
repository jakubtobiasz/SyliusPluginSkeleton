...
$usePhpSpec = confirm('Enable PhpSpec?', true);
$useBehat = confirm('Enable Behat?', true);
$usePhpStan = confirm('Enable PhpStan?', true);
$usePsalm = confirm('Enable Psalm?', true);
$useDocker = confirm('Enable Docker?', true);
...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/AcmeSyliusExamplePlugin.php')) => rename($file, determineSeparator('./src/'.$className.'.php')),
